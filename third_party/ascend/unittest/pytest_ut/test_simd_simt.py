...
@triton.jit
def simple_indirect_load_add_kernel(
    src_ptr,
    indices_ptr,
    out_ptr,
    add_value,
...
def test_simple_indirect_load_add():
    ...
    indices = torch.tensor([10, 25, 100, 200, 5, 50, 150, 255],
    ...
    add_value = 3.0
    grid = (1,)
    simple_indirect_load_add_kernel[grid](
        src, indices, output, add_value,
        BLOCK=8,
...
@triton.jit
def indirect_index_load_div_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_div_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_div_kernel[grid](
        src, add_src, indices, output, offset1, offset2,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
@triton.jit
def indirect_index_load_add_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_add_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_add_kernel[grid](
        src, add_src, indices, output,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
@triton.jit
def indirect_index_load_and_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_and_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_and_kernel[grid](
        src, add_src, indices, output, offset1, offset2,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
@triton.jit
def indirect_index_load_max_min_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_max_min_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_max_min_kernel[grid](
        src, add_src, indices, output, offset1, offset2,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
@triton.jit
def indirect_index_load_mul_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_mul_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_mul_kernel[grid](
        src, add_src, indices, output, offset1, offset2,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
@triton.jit
def indirect_index_load_or_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_or_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_or_kernel[grid](
        src, add_src, indices, output, offset1, offset2,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
@triton.jit
def indirect_index_load_sub_kernel(
    src_ptr,
    add_ptr,
    indices_ptr,
    out_ptr,
...
def test_indirect_index_load_sub_kernel():
    ...
    # add_value = 3.0
    grid = (1,)
    indirect_index_load_sub_kernel[grid](
        src, add_src, indices, output, offset1, offset2,
        BLOCK=8,
        compile_mode='simd_simt'
    )
...
def test_simple_indirect_load_2d_min():
    ...
    simple_indirect_load_2d_min_kernel[(1,)](
        src,
        indices,
        output,
        N,
...
def test_simple_indirect_load_2d():
    ...
    simple_indirect_load_2d_kernel[grid](
        src,
        indices,
        output,
        N,
...
@triton.jit
def simple_indirect_load_kernel(
    src_ptr,
    indices_ptr,
    out_ptr,
    BLOCK: tl.constexpr
...
@triton.jit
def simple_indirect_store_kernel(
    dst_ptr,
    indices_ptr,
    values_ptr,
    BLOCK: tl.constexpr
...
def test_simd_simt():
    tests = [
        test_simple_indirect_load_add,
        test_indirect_index_load_div_kernel,
        test_indirect_index_load_add_kernel,
        test_indirect_index_load_and_kernel,
        test_indirect_index_load_max_min_kernel,
        test_indirect_index_load_mul_kernel,
        test_indirect_index_load_or_kernel,
        test_indirect_index_load_sub_kernel,
        test_simple_indirect_load_2d_min,
        test_simple_indirect_load_2d,
        test_simple_indirect_load,
        test_index_put,
        test_index_select,
        test_simple_indirect_store
    ]
