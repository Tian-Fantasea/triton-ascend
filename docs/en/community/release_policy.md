...
- Each release version creates a corresponding release development branch (e.g., `releases/3.2.x`), which has the same commit id as the community release
...
| ----------------- | -------- | ---------------- | ----------------------------------- | ------------ |
| `main`            | `Active`   | `3.5.0`          | /                                   | /            |
| `releases/3.2.1` | `Active`   | `3.2.0`          | `3.2.1`                             | /            |
| `releases/3.2.x` | `Maintenance`   | `3.2.0`          | `3.2.0rc2`，`3.2.0rc3`，`3.2.0rc4`，`3.2.0` | /            |
